...
import { confirmSection, confirmSummaryLine, readConfirmRecord } from "./confirm-report";
import type { ConfirmRead } from "./confirm-report";
...
async function main(): Promise<number> {
  ...
  lines.push(`  time to confirm: ${confirmSummaryLine(confirm)}`);
  lines.push(
